...
int main()
{
    ...
    cout << &yt1.sheep_b << endl;
    cout << (intptr_t *)&yt1+2 << endl;
    cout << &yt1.tuo_c << endl;//d8
    cout << &yt1.sheeptuo_d << endl;//dc!!! 并不像是补全    这两个是连续的int  相当于8 
    cout << "    " << (int*)((intptr_t *)&yt1 + 2) +3<< endl;
    cout << "    " << (intptr_t *)&yt1 + 4 << endl; // 我们用
    cout << &yt1.animal_a << endl;//            能这样看变量地址的话，模型就很快了
    ...
    intptr_t *yt_p2 = (intptr_t *)*((intptr_t *)&yt1+2);
    cout << "使用第二个vfptr" << endl;
    ((void (*)()) * (yt_p2))();
    cout << endl;
    cout << *((intptr_t *)&yt1 + 3) << endl;
    cout << *((intptr_t *)&yt1 + 3) << endl;
    cout << *((intptr_t *)&yt1 + 3)  << endl;
    cout << endl;
     intptr_t *yt_p3 = (intptr_t *)*((intptr_t *)&yt1 + 4);
     cout << "使用第三个vfptr" << endl;
     ((void (*)()) * (yt_p3+1))();//第三个指针！！
    // cout << endl;
    cout << "vftable的使用" << endl;
    ((void (*)()) * (yt_p1 + 7))();
    ((void (*)()) * (yt_p1 + 13))();//表的连续性
    return 0;
}
