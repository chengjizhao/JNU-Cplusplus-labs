...
void Address::printAddr()const
{
	std::cout << addr << std::endl;
}

void Address::setAddr(const char* addr)
{
	this->addr = addr;
}

void Address::addPerson(std::shared_ptr<Person> sp)
{
	persons.push_back(sp); // ÒşÊ½×ª»»
}
